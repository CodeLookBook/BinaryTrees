...
namespace BinaryTrees.Traversal.Tests
{
    ...
    public class PreOrderTraversalTests
    {
        ...
        static ITraversal<TestNode<int>, int> Traversal => new PreOrderTraversal<TestNode<int>, int>();
        ...
        public void SetUp()
        {
            ExpectedLeftToRightTraversalResult = new List<int> { 11, 7, 5, 3, 6, 9, 8, 10, 15, 13, 12, 14, 20, 18, 25 };
            ExpectedRightToLeftTraversalResult = new List<int> { 11, 15, 20, 25, 18, 13, 14, 12, 7, 9, 10, 8, 5, 6, 3 };
        ...
        public static TestCaseData[] Traverse_Data_2 => new TestCaseData[]
        {
            new TestCaseData(CreateIntTreeRootNode(), TraversalMode.LeftToRight).Returns(
                new List<int> { 11, 7, 5, 3, 6, 9, 8, 10, 15, 13, 12, 14, 20, 18, 25 }),
            new TestCaseData(CreateIntTreeRootNode(), TraversalMode.RightToLeft).Returns(
                new List<int> { 11, 15, 20, 25, 18, 13, 14, 12, 7, 9, 10, 8, 5, 6, 3 }),
