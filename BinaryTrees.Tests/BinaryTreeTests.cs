...
{
    class TestTree<KeyT> : BinaryTree<TestNode<KeyT>, KeyT> where KeyT : IComparable
    {
        protected override void InsertNode(TestNode<KeyT> parentNode, TestNode<KeyT> newNode)
        {
            throw new NotImplementedException();
        }
    }
    class TestNode<KeyT> : BinaryTreeNode<TestNode<KeyT>, KeyT> where KeyT : IComparable { }
    ...
    public class BinaryTreeTests
    {
        ...
        private TestNode<int>    CreateIntTreeRootNode()
        {
            ...
            {
                Key = 11,
                LeftNode = new TestNode<int>
                {
                    Key = 7,
                    LeftNode = new TestNode<int>
                    {
                        Key = 5,
                        LeftNode = new TestNode<int> { Key = 3, },
                        RightNode = new TestNode<int> { Key = 6, }
                    },
                    RightNode = new TestNode<int>
                    {
                        Key = 9,
                        LeftNode = new TestNode<int> { Key = 8, },
                        RightNode = new TestNode<int> { Key = 10, }
                    }
                },
                RightNode = new TestNode<int>
                {
                    ...
                    {
                        Key = 13,
                        LeftNode = new TestNode<int> { Key = 12, },
                        RightNode = new TestNode<int> { Key = 14, }
                    },
                    RightNode = new TestNode<int>
                    {
                        Key = 20,
                        LeftNode = new TestNode<int> { Key = 18, },
                        RightNode = new TestNode<int> { Key = 25, }
                    }
                }
            };
        }
        private TestNode<string> CreateStrTreeRootNode()
        {
            ...
            {
                Key = "K",
                LeftNode = new TestNode<string>
                {
                    Key = "G",
                    LeftNode = new TestNode<string>
                    {
                        Key = "E",
                        LeftNode = new TestNode<string> { Key = "C", },
                        RightNode = new TestNode<string> { Key = "F", }
                    },
                    RightNode = new TestNode<string>
                    {
                        Key = "I",
                        LeftNode = new TestNode<string> { Key = "H", },
                        RightNode = new TestNode<string> { Key = "J", }
                    }
                },
                RightNode = new TestNode<string>
                {
                    ...
                    {
                        Key = "M",
                        LeftNode = new TestNode<string> { Key = "L", },
                        RightNode = new TestNode<string> { Key = "N", }
                    },
                    RightNode = new TestNode<string>
                    {
                        Key = "T",
                        LeftNode = new TestNode<string> { Key = "R", },
                        RightNode = new TestNode<string> { Key = "Y", }
                    }
                }
            };
        }
